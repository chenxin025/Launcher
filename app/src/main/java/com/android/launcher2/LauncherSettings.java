...
class LauncherSettings {
	 ...
	 */
	static final class ScreenMapping implements BaseColumns {
		
		public static final int NORMAL = 1;
		public static final int EDIT = 2;
		
		/**
		 * the screen id stored in favorites table, this id is not the actual
		 * the screen id the view located, so, when displaying it, we need to 
		 * mapping it to the actual one. 
		 */
		static final String LOGIC_SCREEN = "logic_screen";
		
		/**
		 * The actual screen id which the shortcut is located.  
		 */
		static final String ACTUAL_SCREEN = "actual_screen";
		
		/**
		 * indicate mode the screen belong to. If MODE=EDIT, it means the screen
		 * is the first or last one in edit mode, which a add button icon is on.
		 */
		static final String MODE = "mode";
		
		static final Uri CONTENT_URI = Uri.parse("content://" +
                LauncherProvider.AUTHORITY + "/" + LauncherProvider.TABLE_SCREEN_MAPPING +
                "?" + LauncherProvider.PARAMETER_NOTIFY + "=true");
		
		static Uri getContentUri(long id, boolean notify) {
            return Uri.parse("content://" + LauncherProvider.AUTHORITY +
                    "/" + LauncherProvider.TABLE_SCREEN_MAPPING + "/" + id + "?" +
    ...
    static final class Favorites implements BaseLauncherColumns {
        ...
        */
        ...
        //added by ETON guolinan
       	static final String FIRST_INSTALL_TIME = "firstInstallTime";
       	static final String IS_NEW = "isNew";
       	static final String CALLED_NUM = "calledNum";
    	static final int CONTAINER_APPLICATIONS = -200;
    	static final int ITEM_IS_NEW = 1;
    	static final int ITEM_NOT_NEW = 0;
       	//end
    	
    	//>>added by ETON wanghenan
       	static final String APP_LAUNCH_COUNT = "appLaunchCount";
       	static final String APP_LAUNCH_LAST_TIME = "appLaunchLastTime";
        //<<end
