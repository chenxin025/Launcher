...
public class MTKUnreadLoader extends BroadcastReceiver {
    ...
    public void onReceive(final Context context, final Intent intent) {
        ...
        /*if (Intent.MTK_ACTION_UNREAD_CHANGED.equals(action)) {
            ...
            // for addind corner mark to dialtact icon, the intent system send is different from dialtacts main activity
//            if (componentName.toString()
//            		.equals("ComponentInfo{com.android.contacts/com.android.contacts.activities.DialtactsActivity}")){
//            	componentName = new ComponentName("com.android.contacts", "com.android.contacts.topactivities.DialtactsPeopleEntrySplashScreenActivity");
//            }
            // end
